...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaWhatsapp, FaClock, FaEdit, FaRegBuilding, FaSearch } from "react-icons/fa";
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          ...
          <p className="text-gray-500 mb-4">Administra la información de contacto y configuración de proveedores</p>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 mt-10">
        ...
        {/* Cards */}
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-24 justify-center">
          {cards.map((card, idx) => (
            <div
              key={idx}
              className="relative flex w-80 flex-col rounded-xl bg-gradient-to-br from-white to-gray-50 bg-clip-border text-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 mb-8"
            >
              <div className="relative mx-4 -mt-6 h-40 overflow-hidden rounded-xl shadow-lg group">
                {card.img ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-gray-200 text-gray-400 text-4xl font-bold">?</div>
                )}
              </div>
              <div className="p-6">
                <h5 className="mb-2 text-xl font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                  {card.title}
                </h5>
              ...
              <div className="p-6 pt-0">
                <button
                  className="group relative w-full inline-flex items-center justify-center px-6 py-3 font-bold text-white rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-lg shadow-blue-500/30 transition-all duration-300"
