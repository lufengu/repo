...
function NuevoPedidoModal({ open, onClose, onCreate, pedido }) {
  ...
  const [productosAgotarse, setProductosAgotarse] = useState([]);
  const [showProductosSugeridos, setShowProductosSugeridos] = useState(false);
  ...
  useEffect(() => {
    ...
    if (open) {
      ...
      // Se elimina la lógica de productos sugeridos
    }
  }, [pedido, open]);
